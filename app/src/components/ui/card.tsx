...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "luxury-surface rounded-2xl text-ink",
      "transition-premium",
      "hover:-translate-y-0.5 hover:border-brand/40 hover:shadow-[0_18px_36px_-16px_rgba(0,0,0,0.7)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "font-display text-2xl leading-tight tracking-tight text-ink",
      className
    )}
    {...props}
  />
