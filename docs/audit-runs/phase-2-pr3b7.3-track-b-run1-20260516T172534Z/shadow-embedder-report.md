...
Generated: 2026-05-16T17:28:48.314Z
...
| shadow rows already embedded | 35 |
| shadow rows eligible (embedding IS NULL) | 1918 |
...
| metric | value |
|---|---:|
| fetched eligible (capped by --limit) | 1000 |
| embedded this run | 1000 |
| skipped (would-overlap with --limit) | 918 |
| estimated tokens | 252659 |
| **estimated cost (USD, @ $0.02/1M tokens)** | **$0.0051** |

## Post-write probes

| probe | pre | post | Δ | expected |
|---|---:|---:|---:|---|
| shadow rows already embedded | 35 | 1035 | 1000 | == embedded this run (1000) |
